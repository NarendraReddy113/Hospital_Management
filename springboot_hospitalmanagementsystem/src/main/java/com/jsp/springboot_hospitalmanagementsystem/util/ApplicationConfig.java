package com.jsp.springboot_hospitalmanagementsystem.util;
...
public class ApplicationConfig {
	...
	public Docket getDocket() {
		...
		return new Docket(DocumentationType.SWAGGER_2).select().apis(RequestHandlerSelectors.basePackage("com.jsp.springboot_hospitalmanagementsystem"))
